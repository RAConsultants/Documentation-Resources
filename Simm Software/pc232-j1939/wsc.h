...
//  wsc.h (version 5.0.0)
//
//  Used for Win16, Win32, and Win64
...
NoMangle int DLL_IMPORT_EXPORT SioHexView(LPSTR,int,LPSTR,int);
#ifdef WIN32_WIN64
NoMangle int DLL_IMPORT_EXPORT SioWinError(LPSTR,int);
NoMangle int DLL_IMPORT_EXPORT SioEvent(int, DWORD);
NoMangle int DLL_IMPORT_EXPORT SioEventWait(int, DWORD, DWORD);
NoMangle int DLL_IMPORT_EXPORT SioEventChar(int, char , DWORD);
...
NoMangle int DLL_IMPORT_EXPORT SioSetTimeouts(int,DWORD,DWORD,DWORD,DWORD,DWORD);
NoMangle void DLL_IMPORT_EXPORT SioSleep(int);
#endif
